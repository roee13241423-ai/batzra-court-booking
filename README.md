...
- **שריון** (`/booking`) - לאחר האישור, המשתמש רואה לוח שבוע (7 ימים × 18 שעות, 06:00-24:00) עם תאריכים אמיתיים, וניתן לנווט קדימה לשבועות הבאים. לחיצה על משבצת פנויה יוצרת שריון חד-פעמי לאותו תאריך ושעה בלבד, ושולחת מייל אישור למשריין. משבצות שכבר עברו מוצגות כלא-זמינות, ומשבצות תפוסות מציגות גם את שם השריין.
