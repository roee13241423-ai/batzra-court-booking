...
- **מזג אוויר** - בכותרת מוצג התאריך, שעון חי, ומזג האוויר הנוכחי (דרך [Open-Meteo](https://open-meteo.com), חינמי וללא צורך במפתח API). ביום חם ונעים למשחק מופיעה עיטור שמש מונפש.
